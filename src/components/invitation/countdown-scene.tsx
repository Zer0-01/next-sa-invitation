    ...
    >
      <div className="relative z-10 flex w-full max-w-md flex-col items-center">
        ...
        <Button
          ...
          className="mt-7 h-auto rounded-full border border-white/28 bg-white/14 px-6 py-3 text-[0.62rem] uppercase tracking-[0.2em] text-white shadow-none hover:bg-white/20"
        >
          Simpan kalendar
        </Button>
      </div>
