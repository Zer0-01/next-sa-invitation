...
const DoaComponent = () => {
    return (
        <section className="py-24 bg-[#f9f9f9] px-6 text-center overflow-hidden">
            <motion.div
            ...
            >
                <div className="space-y-4">
                    <p className="text-xl md:text-2xl font-serif text-gray-800 leading-relaxed font-medium">
                ...
                <div className="space-y-6">
                    <p className="text-lg md:text-2xl font-serif text-gray-700 leading-relaxed italic px-4">
